...
public class theBeatlesInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_the_beatles_info);
        ...
        playSample = MediaPlayer.create(this, R.raw.beatles);
        ...
        calculation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                if(txtNumP.isEmpty()){
                    Toast.makeText(theBeatlesInfo.this,"Must enter number of tickets.", Toast.LENGTH_LONG).show( );}
                else {
    ...
    public void seePersonInfo1(View v){
        startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://en.wikipedia.org/wiki/John_Lennon")));
    }
    public void seePersonInfo2(View v){
        startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://en.wikipedia.org/wiki/Paul_McCartney")));
    }
    public void seePersonInfo3(View v){
        startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://en.wikipedia.org/wiki/Ringo_Starr")));
    }
    public void seePersonInfo4(View v){
        startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://en.wikipedia.org/wiki/George_Harrison")));
    }
    public void backHome(View v){
        startActivity(new Intent(theBeatlesInfo.this, MainActivity.class));
        playSample.stop();
        button2.setVisibility(View.INVISIBLE);
        button1.setVisibility(View.VISIBLE);
    }
