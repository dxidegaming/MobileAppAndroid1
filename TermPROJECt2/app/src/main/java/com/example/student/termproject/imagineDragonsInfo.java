...
public class imagineDragonsInfo extends AppCompatActivity {
    ImageButton button1 , button2;
    MediaPlayer playSample;
    final double tax=0.0875;
    double ticketCost = 49.99;
    double VIPticket = 99.99;
    double ordersInput;
    boolean VIPYorN;
    double totalCost;
    double partialCost;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_imagine_dragons_info);
        ...
        playSample = MediaPlayer.create(this, R.raw.imaginedragons);
        ...
        calculation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                if(txtNumP.isEmpty()){
                    Toast.makeText(imagineDragonsInfo.this,"Must enter number of tickets.", Toast.LENGTH_LONG).show( );}
                else {
    ...
    public void seePersonInfo1(View v){
        startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://en.wikipedia.org/wiki/Dan_Reynolds_(singer)")));
    }
    public void seePersonInfo2(View v){
        startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://en.wikipedia.org/wiki/Wayne_Sermon")));
    }
    public void seePersonInfo3(View v){
        startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://en.wikipedia.org/wiki/Ben_McKee")));
    }
    public void seePersonInfo4(View v){
        startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://en.wikipedia.org/wiki/Daniel_Platzman")));
    }
    public void backHome(View v){
        startActivity(new Intent(imagineDragonsInfo.this, MainActivity.class));
        playSample.stop();
        button2.setVisibility(View.INVISIBLE);
        button1.setVisibility(View.VISIBLE);
    }
